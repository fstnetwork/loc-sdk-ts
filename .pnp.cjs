  ...
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "packageRegistryData": [\
      ...
      ["@fstnetwork/loc-logic-sdk", [\
        ["workspace:packages/loc-logic-sdk", {\
          ...
          "packageDependencies": [\
            ...
            ["@fstnetwork/runtime", "workspace:packages/runtime"],\
            ["rimraf", "npm:3.0.2"],\
            ["typescript", "patch:typescript@npm%3A5.0.2#~builtin<compat/typescript>::version=5.0.2&hash=f456af"]\
          ],\
          "linkType": "SOFT"\
        }]\
      ]],\
      ...
      ["typescript", [\
        ...
        ["patch:typescript@npm%3A5.0.2#~builtin<compat/typescript>::version=5.0.2&hash=f456af", {\
          "packageLocation": "./.yarn/cache/typescript-patch-33a8492947-bdbf3d0aac.zip/node_modules/typescript/",\
          "packageDependencies": [\
            ["typescript", "patch:typescript@npm%3A5.0.2#~builtin<compat/typescript>::version=5.0.2&hash=f456af"]\
          ],\
          "linkType": "HARD"\
