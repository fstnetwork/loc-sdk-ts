  ...
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "packageRegistryData": [\
      ...
      ["@fstnetwork/loc-logic-sdk", [\
        ["workspace:packages/loc-logic-sdk", {\
          ...
          "packageDependencies": [\
            ...
            ["@fstnetwork/runtime", "workspace:packages/runtime"],\
            ["rimraf", "npm:4.4.1"],\
            ["typescript", "patch:typescript@npm%3A5.1.3#~builtin<compat/typescript>::version=5.1.3&hash=f456af"]\
          ],\
          "linkType": "SOFT"\
        }]\
      ]],\
      ...
      ["typescript", [\
        ...
        ["patch:typescript@npm%3A5.1.3#~builtin<compat/typescript>::version=5.1.3&hash=f456af", {\
          "packageLocation": "./.yarn/cache/typescript-patch-f54d6e723f-32a25b2e12.zip/node_modules/typescript/",\
          "packageDependencies": [\
            ["typescript", "patch:typescript@npm%3A5.1.3#~builtin<compat/typescript>::version=5.1.3&hash=f456af"]\
          ],\
          "linkType": "HARD"\
