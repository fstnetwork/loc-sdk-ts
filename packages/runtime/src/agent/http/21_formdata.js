// reference: copy from https://github.com/denoland/deno/blob/v1.33.1/ext/fetch/21_formdata.js
    ...
    if (typeof value === 'string') {
      ArrayPrototypePush(
        ...
        prefix +
          ...
          CRLF +
          CRLF +
          StringPrototypeReplace(value, FORM_DETA_SERIALIZE_PATTERN, CRLF) +
          CRLF
      );
    } else {
      ArrayPrototypePush(
...
webidl.converters['FormData'] = webidl.createInterfaceConverter(
  'FormData',
  FormDataPrototype
);
