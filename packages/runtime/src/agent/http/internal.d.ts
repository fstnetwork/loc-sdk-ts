// reference: copy from https://github.com/denoland/deno/blob/v1.33.1/ext/fetch/internal.d.ts
...
declare module "ext:saffron_fetch/20_headers.js" {
  class Headers {
  }
...
declare module "ext:saffron_fetch/21_formdata.js" {
...
declare module "ext:saffron_fetch/22_body.js" {
  function mixinBody(
    prototype: any,
    bodySymbol: symbol,
...
declare module "ext:saffron_fetch/26_fetch.js" {
